...
UUID=${UUID:-'20f0e64a-c560-4453-973c-f7e3a32eca87'}
VMESS_WSPATH=${VMESS_WSPATH:-'/vmess-path'}
VLESS_WSPATH=${VLESS_WSPATH:-'/vless-path'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/trojan-path'}
SS_WSPATH=${SS_WSPATH:-'/shadowsocks-path'}
